...
const COMPLIANCE_MODULES = [
  { id:"pdpa", name:"PDPA", full:"Personal Data Protection Act 2010", flag:"🇲🇾", icon:"🔐", color:"#1D4ED8", regulator:"Ministry of Digital",
    desc:"Malaysia's data protection framework covering consent, data subject rights, security safeguards, and breach management for personal data in commercial transactions.",
    requirements:[
      { id:"pdpa_1",code:"P.1",name:"Explicit Consent",desc:"Processing activities requiring consent are identified and documented. Procedures obtain, record and track consent per PDPA Section 40(1). Consent for minors handled per Section 4.",weight:3 },
      { id:"pdpa_2",code:"P.2",name:"Privacy Notice & Disclosure",desc:"Privacy notice is conspicuous, uses plain language, and meets PDPA Section 7 requirements. Procedures ensure data subjects are notified of purposes, rights, and disclosures. No personal data disclosed without consent per Section 8 & 39.",weight:3 },
      { id:"pdpa_3",code:"P.3",name:"Withdrawal of Consent",desc:"Processes and procedures in place for data subjects to withdraw consent per PDPA Section 38(1-2). Withdrawal is acted upon promptly and documented.",weight:3 },
      { id:"pdpa_4",code:"P.4",name:"Collection & Purpose Limitation",desc:"Policies limit personal data collection to what is necessary and restrict use to specified purposes only, per PDPA Section 6(2) and 6(3).",weight:3 },
      { id:"pdpa_5",code:"P.5",name:"Storage, Retention & Disposal",desc:"Retention schedule defined per PDPA Section 10 and PDPS Retention Standard 6. Personal data disposed securely. Records of disposal maintained. Disposal/deletion process approved and documented.",weight:3 },
      { id:"pdpa_6",code:"P.6",name:"Data Security Safeguards",desc:"Access control policy implemented per PDPA Section 9 and PDPS Security Standard 4(2-5). Encryption applied per Section 115. Integrity mechanisms prevent unauthorised changes per Section 11. Role-based access enforced.",weight:3 },
      { id:"pdpa_7",code:"P.7",name:"Data Classification",desc:"Data classification policy addresses sensitivity, criticality, and handling procedures per PDPA Section 9 and GTRM Guideline 7.22(a). Critical Data Elements (CDEs) mapped to specific systems.",weight:2 },
      { id:"pdpa_8",code:"P.8",name:"Data Subject Rights",desc:"Procedures respond to access requests per PDPA Section 31(1), correction requests per Section 35 and 12, and erasure/restriction requests per Section 42(1). Direct marketing opt-out enforced per Section 43.",weight:3 },
  ...
  { id:"nacsa-cop", name:"NACSA COP", full:"NACSA CS Baseline — Code of Practice for CNII", flag:"🇲🇾", icon:"🏛️", color:"#059669", regulator:"NACSA",
    ...
    requirements:[
      { id:"cop_1",code:"C.1",name:"Cyber Security Policy & Objectives",desc:"Cyber security policy established, documented, communicated, enforced and reviewed. Aligned with Act 854 and ISO/IEC 27001:2022. Applied across organisation including third parties. Reviewed annually. Cyber security objectives established, communicated and monitored.",weight:3 },
      { id:"cop_2",code:"C.2",name:"Organisational Development & Resources",desc:"Cyber security roles and responsibilities defined, documented and communicated across the organisation (CISO, security team, department owners). Sufficient qualified personnel allocated. Contacts with relevant authorities and special interest groups maintained and up to date.",weight:3 },
      { id:"cop_3",code:"C.3",name:"Cyber Security Assurance",desc:"IT Acceptable Use Policy established and enforced. Cyber Security Audit programme in place with findings tracked. Supplier Relationship Security requirements embedded in all third party contracts with audit rights.",weight:3 },
      { id:"cop_4",code:"C.4",name:"Asset Management & Risk",desc:"All CNII assets identified, classified and registered in an authoritative asset register. Annual cyber risk assessment conducted using approved methodology. Risk treatment plans documented with owners and target dates.",weight:3 },
      { id:"cop_5",code:"C.5",name:"Data Security & Protection",desc:"Data Leakage Prevention (DLP) controls deployed. Data Privacy and Protection procedures established. Secure configuration baselines applied. Software and Application Security controls in place for all critical systems.",weight:3 },
      { id:"cop_6",code:"C.6",name:"Access Control & IAM",desc:"Identity and Access Management (IAM) programme in place with RBAC enforced. Password Management System implemented. Segregation of Duties applied for critical functions. Access reviews conducted regularly.",weight:3 },
      { id:"cop_7",code:"C.7",name:"System & Network Security",desc:"Network Security Policies and Procedures documented. Physical and logical network diagrams maintained and up to date. Network Security Controls implemented. Malware Detection and Prevention deployed across all systems.",weight:3 },
      { id:"cop_8",code:"C.8",name:"Technical Vulnerability Management",desc:"Vulnerability assessments conducted on all CNII systems. Vulnerability Management Procedure documented with remediation SLAs. Penetration testing conducted annually by approved service provider.",weight:2 },
      { id:"cop_9",code:"C.9",name:"Event & Incident Management",desc:"Security Event Management (SIEM) deployed with defined use cases and alerting. Incident Procedure and Handling documented and tested. Cyber incidents reported to MyCERT/NACSA within required timeframes (Sev1: 1hr, Sev2: 4hr).",weight:3 },
      { id:"cop_10",code:"C.10",name:"Business Continuity & Recovery",desc:"Business Continuity Plan (BCP) documented and covers cyber scenarios. BCP tested via tabletop and simulation exercises. Lessons learned integrated into BCP updates. Recovery capability validated against defined RTO/RPO.",weight:3 },
    ]},
  { id:"bnm-rmit-a10", name:"BNM RMiT App.10", full:"BNM RMiT Appendix 10 — Cloud Risk Management", flag:"🇲🇾", icon:"☁️", color:"#DC2626", regulator:"Bank Negara Malaysia",
    desc:"BNM RMiT Appendix 10 cloud-specific controls covering governance, due diligence on CSPs, contract management, cloud architecture, access controls, backup/recovery and cyber response.",
    requirements:[
      { id:"a10_1",code:"A10-A01",name:"Cloud Risk Management & Governance",desc:"Board promotes sound governance principles for cloud. Senior management develops and implements a Risk Management Framework covering cloud. Shared responsibility model documented. Cloud contracts address data protection, regulatory assurance, and cross-functional accountability. Cloud risk management reviewed periodically.",weight:3 },
      { id:"a10_2",code:"A10-A02",name:"Cloud Usage Policy",desc:"Cloud Usage Policy approved by governance. Cloud asset inventory maintained. Policy reviewed and updated as cloud landscape evolves.",weight:3 },
      { id:"a10_3",code:"A10-A03",name:"Due Diligence on CSPs",desc:"Risk-based due diligence conducted on all Cloud Service Providers (CSPs) before engagement and periodically thereafter.",weight:3 },
      { id:"a10_4",code:"A10-A05",name:"Cloud Contract Management",desc:"Contract terms address jurisdiction risk, customer data protection, investigation and regulatory support, fourth-party oversight, and SLA accountability.",weight:3 },
      { id:"a10_5",code:"A10-A06",name:"Oversight over CSPs",desc:"Continuous oversight of CSPs maintained. Accountability frameworks in place. Periodic assessments and reactive reviews conducted when significant changes occur.",weight:3 },
      { id:"a10_6",code:"A10-A07",name:"Skilled Personnel",desc:"Board, senior management, IT/security operations, audit/risk/compliance, and staff trained on cloud risk. Cross-functional engagement in cloud risk management. Consequence management for non-compliance.",weight:2 },
      { id:"a10_7",code:"A10-B01",name:"Cloud Architecture & Security",desc:"Robust cloud architecture implemented. Zero-trust architecture adopted. Secure encrypted migration channels and connectivity. Tenant isolation in shared infrastructure. Secure API design and lifecycle management.",weight:3 },
      { id:"a10_8",code:"A10-B05",name:"Cloud Backup & Recovery",desc:"Cloud-inclusive backup and recovery planning in place. Ongoing backup validation with risk-based frequency. VM/container backup and replication. Resilience and redundancy strategy documented and tested.",weight:3 },
      { id:"a10_9",code:"A10-B09",name:"Cloud Access Controls",desc:"Secure access to cloud management plane. User Access Matrix and CSP roles defined and reviewed. Hypervisor/cloud admin console access restricted. Federated identity and context-aware IAM implemented.",weight:3 },
      { id:"a10_10",code:"A10-B10",name:"Cybersecurity Operations",desc:"Cybersecurity operations governance extended to cloud. Supply chain risk assessed for cloud services. VAPT and vulnerability management conducted for cloud systems.",weight:2 },
      { id:"a10_11",code:"A10-B14",name:"Cyber Response & Recovery",desc:"Cyber readiness for cloud incidents established. Cloud incident coverage in incident response plan. Incident detection, customer support, and cross-border incident procedures documented. Integrated cyber drills with CSPs conducted.",weight:3 },
      { id:"a10_12",code:"A10-B07",name:"Exit Strategy",desc:"Exit strategy planning integrated into cloud risk framework. Operational exit plan documented with execution readiness validated.",weight:2 },
    ]},
  { id:"bnm-iesp", name:"BNM IESP", full:"BNM RMiT — Internet & E-Banking Security / Process Controls", flag:"🇲🇾", icon:"🏦", color:"#B45309", regulator:"Bank Negara Malaysia",
    desc:"BNM RMiT Process Control Requirements covering access control, operations security, communication security, incident management and business continuity for internet and e-banking services.",
    requirements:[
      { id:"iesp_1",code:"PC-AC01",name:"User Access Management",desc:"Policies and procedures for user access management in place. Formal provisioning and revoking processes documented. Privileged access rights controlled. User Access Matrix reviewed and monitored regularly.",weight:3 },
      { id:"iesp_2",code:"PC-AC02",name:"3rd Party & Vendor Access",desc:"User data protected in third party engagements. Non-Disclosure Agreements in place. Transfer of information controls documented. Third party network access controlled. Contract management includes security requirements. DLP system deployed for third party data flows.",weight:3 },
      { id:"iesp_3",code:"PC-AC03",name:"System & Application Access Control",desc:"Information access restrictions implemented. Secure log-on procedures enforced. Approval procedures for elevated access documented. Database access controls in place. Access security controls reviewed regularly.",weight:3 },
      { id:"iesp_4",code:"PC-AC04",name:"Source Code Access Control",desc:"Source code management processes documented. Access control to source code library enforced with audit logs. Check-in/check-out procedures in place. Validation controls applied.",weight:2 },
      { id:"iesp_5",code:"PC-OS01",name:"System Testing",desc:"System testing conducted in controlled environment. Testing of new/enhanced products with defined test controls. Change management process followed. Backup procedure before deployment. Rollback plan documented and validated.",weight:3 },
      { id:"iesp_6",code:"PC-OS02",name:"Change Management",desc:"Policies and procedures for change management documented and enforced. UAT testing conducted before production deployment. Approval procedures followed. Rollback plan tested.",weight:3 },
      { id:"iesp_7",code:"PC-OS03",name:"Capacity Management",desc:"Resource usage monitored and projected. Risk assessment conducted for capacity constraints. Capacity planning tools deployed. Threshold alerts configured. Subsequent actions and acceptance testing documented.",weight:2 },
      { id:"iesp_8",code:"PC-CS01",name:"Communication Security",desc:"Network architecture documented with security controls. Policies and procedures for communication security in place. Data protection procedures implemented. Cryptographic techniques applied to protect data in transit.",weight:3 },
      { id:"iesp_9",code:"PC-IM01",name:"Incident Management",desc:"Policies and procedures for information security incident management documented. Management responsibilities defined. Evidence collection procedures in place. Incidents reported and tracked to resolution.",weight:3 },
      ...
      <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:20,maxWidth:720,width:"100%"}}>
        {[
          ...
          { id:"compliance", icon:"📋", title:"Compliance", sub:"Regulatory Framework Readiness Assessment",
            ...
            tags:["PDPA","NACSA COP","BNM RMiT App.10","BNM IESP","SC GTRM"], accent:"#1D4ED8" },
        ].map(cat=>(
